...
//
//      Check secondCheck = new Check("Check2", "Change Notice", "Proposed Solution", "", "comment2");
//      ActionValueType actionType2 = new ActionValueType("NotEmpty", "", "pls2");
//      actionType2.add(secondCheck);
//
//      Check check6 = new Check("Check6", "Change Notice", "Customer Approval Required", "No", "comment3");
//      ActionValueType actionType6 = new ActionValueType("IsEqual", "String", "pls3");
//      actionType6.add(check6);
//
//      Check thirdCheck = new Check("Check3", "Change Notice", "supplier Approval Required", "No", "comment3");
...
//
//      Check check5 = new Check("Check5", "Change Request", "Request priority", "", "comment3");
