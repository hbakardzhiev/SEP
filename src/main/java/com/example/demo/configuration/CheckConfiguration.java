...
public class CheckConfiguration {
  ...
  CommandLineRunner commandLineCheck(
    ...
    return args -> {
      ...
      //
      //      Check check11 = new Check("Check11", "Controlled Document", "name", "FRU",
      // "comment3");
      ...
      //
      //      Check check13 = new Check("Check13", "Controlled Document", "phiSendNative", "",
      // "comment3");
      //      Action actionType13 = actionRepository.getById("HumanCheck");
      //      actionType13.add(check13);
      //
      //      Check check14 = new Check("Check14", "Controlled Document", "phiDMR", "Yes",
      // "comment3");
      ...
      //      Check check15 =
      //          new Check(
      //              "Check15", "Controlled Document", "designcategory", "3. Design Output",
      // "comment3");
      ...
      //
      //      Check check20 = new Check("Check20", "GS1 Packaging Sheet", "phiSendNative", "",
      // "comment3");
      //      Action actionType20 = actionRepository.getById("HumanCheck");
      //      actionType20.add(check20);
      //
      //      Check check21 = new Check("Check21", "GS1 Packaging Sheet", "phiDMR", "Yes",
      // "comment3");
      ...
      //      Check check22 =
      //          new Check(
      //              "Check22", "GS1 Packaging Sheet", "designcategory", "3. Design Output",
      // "comment3");
      ...
      //
      //      Check check25 =
      //          new Check("Check25", "Engineered Part", "phiPhantomManufacturingPart", "No",
      // "comment3");
      //      Action actionType25 = actionRepository.getById("IsEqual");
      //      actionType25.add(check25);
      //
      //      Check check26 =
      //          new Check("Check26", "Engineered Part", "maturity", "Production/Service",
      // "comment3");
      ...
      //      Check check29 =
      //          new Check(
      //              "Check29", "Configurable Part", "phiPhantomManufacturingPart", "No",
      // "comment3");
      ...
      //      Check check30 =
      //          new Check(
      //              "Check30", "Configurable Part", "phiPhantomManufacturingPart", "Yes",
      // "comment3");
      //      Action actionType30 = actionRepository.getById("IsEqual");
      //      actionType30.add(check30);
      //
      //      Check check31 =
      //          new Check("Check31", "Configurable Part", "maturity", "Production/Service",
      // "comment3");
      ...
      repository.saveAll(
          List.of(
              firstCheck, secondCheck, thirdCheck, forthCheck, check5, check6, check7, check8
              //              check9,
              //              check10,
              //              check11,
              //              check12,
