...
public class CheckConfiguration {
  ...
  CommandLineRunner commandLineCheck(CheckRepository repository) {
    ...
    return args -> {
      ...
      ActionValueType actionType2 = new ActionValueType("NotEmpty", "null", "pls2");
      ...
      ActionValueType actionType4 = new ActionValueType("NotEmpty", "null", "pls3");
      actionType4.add(forthCheck);

      Check check5 = new Check("Check5", "Change Request", "theRequestPriority", "null", "comment3");
      ActionValueType actionType5 = new ActionValueType("NotEmpty", "null", "pls3");
