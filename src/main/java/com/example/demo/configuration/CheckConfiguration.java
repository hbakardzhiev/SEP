...
public class CheckConfiguration {
  ...
  CommandLineRunner commandLineCheck(CheckRepository repository, ActionRepository actionRepository) {
    ...
    return args -> {
      Check firstCheck =
          new Check("CN_name", "Change Notice", "name", "", "comment to show when the check fails ");
...
//
      Check check6 =
          new Check("CN_customerApprovalRequired", "Change Notice", "customerApprovalRequired", "No", "comment3");
      Action actionType6 = actionRepository.getById("IsEqual");
      actionType6.add(check6);
//
      Check thirdCheck =
          new Check("CN_supplierApprovalRequired", "Change Notice", "supplierApprovalRequired", "No", "comment3");
      ...
      Check check5 = new Check("CR_RequestPriority", "Change Request", "theRequestPriority", "", "comment3");
      Action actionType5 = actionRepository.getById("NotEmpty");
      actionType5.add(check5);

      Check check7 =
          new Check("CR_customerApprovalRequired", "Change Request", "customerApprovalRequired", "No", "comment3");
      Action actionType7 = actionRepository.getById("IsEqual");
      actionType7.add(check7);

      Check check8 =
          new Check("CR_supplierApprovalRequired", "Change Request", "supplierApprovalRequired", "No", "comment3");
