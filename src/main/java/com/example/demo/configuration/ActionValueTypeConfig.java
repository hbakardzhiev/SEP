...
public class ActionValueTypeConfig {
  ...
  @Bean
  CommandLineRunner commandLineRunnerActionTypes(ActionValueTypeRepository repository) {
    return args -> {
      final var actions =
          List.of(
              ...
              new ActionValueType("NotContains", "String", "sth"),
              new ActionValueType("StrictlyGreater", "Integer", "Description"),
