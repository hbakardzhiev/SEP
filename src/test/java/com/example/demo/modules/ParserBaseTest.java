...
class ParserBaseTest {
    ...
    void testSetDocumentByUrl() throws IOException {
        ...
        //   test threw
        //   java.lang.NullPointerException: Cannot invoke "java.util.stream.Stream.map(java.util.function.Function)" because "url" is null
    ...
    void testParsePage() throws IOException {
        ...
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        //   java.lang.NullPointerException: Cannot invoke "java.util.stream.Stream.parallel()" because "sheetSourceStream" is null
