...
class ParserCTTest {
    ...
    void testConstructor2() throws IOException {
        ...
        //   test threw
        //   java.lang.NullPointerException: Cannot invoke "com.example.demo.modules.ParserCN.getDocument()" because "parserCN" is null
    ...
    void testConstructor4() throws IOException {
        ...
        //   Diffblue Cover tried to run the arrange/act section, but the method under
        //   test threw
        //   java.lang.NullPointerException: Cannot invoke "org.jsoup.nodes.Document.select(String)" because "element" is null
    ...
    void testConstructor5() throws IOException {
        ...
        HashMap<String, Document> stringDocumentMap = new HashMap<>();
        stringDocumentMap.put("a:matchesOwn(^([M]?[D]?[E]?CT[\\d]{6}))",
