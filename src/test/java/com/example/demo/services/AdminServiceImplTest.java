...
class AdminServiceImplTest {
    ...
    void testGetAdminById2() {
        when(this.adminRepoistory.getById((Long) any())).thenThrow(new UsernameNotFoundException("Msg"));
    ...
    void testLoadUserByUsername2() throws UsernameNotFoundException {
        ...
        //       at com.example.demo.services.AdminServiceImpl.loadUserByUsername(AdminServiceImpl.java:96)
