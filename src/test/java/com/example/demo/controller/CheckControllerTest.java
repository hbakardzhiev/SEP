...
class CheckControllerTest {
  ...
  @MockBean private CheckWrapperService checkWrapperService;
  ...
  void testAddCheck2() throws Exception {
    ...
    checkList.add(check);
    when(this.checkService.toCheckAndActionName((Check) any()))
        .thenReturn(new CheckAndActionName());
    ...
    MockMvcBuilders.standaloneSetup(this.checkController)
        ...
        .andExpect(MockMvcResultMatchers.content().contentType("application/json"))
        .andExpect(
            MockMvcResultMatchers.content().string("[{\"theCheck\":null,\"actionName\":null}]"));
  }
    ...
    MockMvcBuilders.standaloneSetup(this.checkController)
        ...
        .andExpect(
            MockMvcResultMatchers.content()
                .string(
                    "[{\"theCheck\":null,\"actionName\":null},{\"theCheck\":null,\"actionName\":null}]"));
  }
