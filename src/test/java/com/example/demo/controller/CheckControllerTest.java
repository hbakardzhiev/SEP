...
class CheckControllerTest {
    ...
    MockMvcBuilders.standaloneSetup(this.checkController)
        ...
        .andExpect(
            MockMvcResultMatchers.content()
                .string(
                    "[{\"theCheck\":{\"name\":\"?\",\"docSource\":\"?\",\"attribute\":\"?\",\"value\":\"42\",\"comments\":\"?\",\"actionValueType\":{\"action\":\"?\",\"valueType\":\"42\",\"description\":\"The"
  ...
  void testDeleteCheck() throws Exception {
    ...
    MockHttpServletRequestBuilder requestBuilder =
        MockMvcRequestBuilders.delete("/check/{name}", "Name");
    MockMvcBuilders.standaloneSetup(this.checkController)
        .build()
        .perform(requestBuilder)
        .andExpect(MockMvcResultMatchers.status().isOk())
  ...
  void testGetCheck() throws Exception {
    ...
    when(this.checkService.findByName((String) any())).thenReturn(check);
    MockHttpServletRequestBuilder requestBuilder =
        MockMvcRequestBuilders.get("/check/{name}", "Name");
    MockMvcBuilders.standaloneSetup(this.checkController)
        .build()
        .perform(requestBuilder)
        .andExpect(MockMvcResultMatchers.status().isOk())
        ...
        .andExpect(
            MockMvcResultMatchers.content()
                .string(
                    "{\"theCheck\":{\"name\":\"Name\",\"docSource\":\"Doc"
                        + " Source\",\"attribute\":\"Attribute\",\"value\":\"42\",\"comments\":\"Comments\",\"actionValueType\":{\"action\":\"Action\",\"valueType\":\"42\",\"description\":\"The"
                        + " characteristics of someone or"
                        + " something\"}},\"actionName\":{\"actionName\":\"Action\"}}"));
  }
